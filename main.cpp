...
main()
{
    ...
    while(e!=0)
    {
        ...
        cout<<"\n\t\t\t\t\t\t\t\ Press 2 to view all rooms status    ";
        cout<<"\n\t\t\t\t\t\t\t\ Press 3 to view room information    ";
        cout<<"\n\t\t\t\t\t\t\t\ Press 4 to view customer information";
        cout<<"\n\t\t\t\t\t\t\t\ Press 5 to edit the data            ";
        cout<<"\n\t\t\t\t\t\t\t\ Press 6 to leave the room           ";
        cout<<"\n\t\t\t\t\t\t\t\ Press 7 to view advance room status ";
        cout<<"\n\t\t\t\t\t\t\t\ Enter 8 to view old record          ";
